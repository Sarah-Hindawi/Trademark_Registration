...
<h1> {{$Status}}</h1> <!--Display the submission status-->
...
<div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
    ...
    @endif
        ...
        <form method="get" action="/search/create" enctype="multipart/form-data">
        @csrf
    ...
    <form method="get" action="/registerTrademark/create" enctype="multipart/form-data">
        @csrf
        <button type="submit" class="button button1">
        <span>
