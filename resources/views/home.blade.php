            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h5>
                            1- What is the policy for registering new trademarks?
                        </h5>

                        <p>
                            A trademark name should be unique within the same category. However, the same trademark name
                            can be used but in a different category.
                        </p>
                        <br>
                        <h5>
                        ...
                        <p>
                            ...
                            You will be asked to fill a form to provide some details. Since only registered users can register,
                            you do not need to provide your name, as it will be retrieved from your authentication information.
                            Trademark names are case-insensitive, as the name will be converted to lower-case letters except
                            for the first letter that will be upper-case. Once you submit the form, you will be redirected
                        ...
                        <p>
                            You do not have to log in for searching purposes only. At the home page, click "Search the
                            Database."
